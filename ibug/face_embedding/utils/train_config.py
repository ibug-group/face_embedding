...
config.output = "../fr_snapshots/arcface_emore_root"
...
config.batch_size = 64  # batch size is 512
config.lr = 0.1
...
if config.dataset == "emore":
...
elif config.dataset == "imagefolder":
    # config.rec = "../datasets/faces_emore"
    # config.num_classes = 85742
    # config.num_image = 5822653
    # config.num_epoch = 16
    ...
    config.val_targets = ["lfw", "cfp_fp", "agedb_30", "calfw", "cplfw"]  # the verification datasets
    config.lr_func = lr_step_func
