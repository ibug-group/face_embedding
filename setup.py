...
with open(os.path.join(script_folder, 'ibug', 'face_embedding', '__init__.py')) as init:
...
# Installation
config = {
    'name': 'ibug_face_embedding',
    'version': _version,
    'description': 'Facial embedding models.',
    'author': 'Jie Shen',
    'author_email': 'js1907@imperial.ac.uk',
    'packages': ['ibug.face_embedding'],
